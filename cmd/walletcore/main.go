...
import (
	...
	"github.com/CarlosHenriqueDamasceno/wallet-ms-fc/internal/database"
	...
	"github.com/CarlosHenriqueDamasceno/wallet-ms-fc/internal/web"
	"github.com/CarlosHenriqueDamasceno/wallet-ms-fc/internal/web/webserver"
...
func main() {
	...
	createTransactionUseCase := create_transaction.NewCreateTransactionUseCase(uow, eventDispatcher, transactionCreated)
